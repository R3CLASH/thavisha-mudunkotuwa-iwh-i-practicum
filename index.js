...
const PRIVATE_APP_ACCESS = 'YOUR_ACCESS_TOKEN';

// TODO: ROUTE 1 - Create a new app.get route for the homepage to call your custom object data. Pass this data along to the front-end and create a new pug template in the views folder.

// * Code for Route 1 goes here
app.get('/', async (req, res) => {
    const customObjectsUrl = 'https://api.hubapi.com/crm/v3/objects/2-226592694?properties=game_name,game_type,game_genre';
    const headers = {
...
app.get('/update-cobj', (req, res) => {
    res.render('updates', { title: 'Games List and Genres' });
});
